...
public final class JsonObject extends JsonValue implements Iterable<Property> {
    ...
    /** The logger for the {@code JsonObject} class. */
    private static final Logger LOGGER = LoggerFactory.getLogger(JsonObject.class, MessageCodes.BUNDLE);
    ...
    private JsonObject(final JsonObject aObject, final boolean aUnmodifiable) {
        Objects.requireNonNull(aObject, LOGGER.getMessage(MessageCodes.JSON_005));
    ...
    @Override
    public int hashCode() {
        return 31 * (31 + myNames.hashCode()) + myValues.hashCode();
    }
    ...
    public ListIterator<Property> iterator() {
        ...
        return new ListIterator<>() {
            ...
            public Property next() {
                if (!hasNext()) {
                    throw new NoSuchElementException(LOGGER.getMessage(MessageCodes.JSON_024));
                }
            ...
            @Override
            public void set(final Property aProperty) {
                throw new UnsupportedOperationException();
            }
        };
    }
    ...
    public JsonObject merge(final JsonObject aObject) {
        for (final Property property : Objects.requireNonNull(aObject, LOGGER.getMessage(MessageCodes.JSON_005))) {
    ...
    public JsonObject remove(final String aName) {
        final int index = indexOf(Objects.requireNonNull(aName, LOGGER.getMessage(MessageCodes.JSON_006)));
    ...
    public JsonObject set(final String aName, final JsonValue aValue) {
        Objects.requireNonNull(aName, LOGGER.getMessage(MessageCodes.JSON_006));
        Objects.requireNonNull(aValue, LOGGER.getMessage(MessageCodes.JSON_007));
    ...
    public static class Property {
        ...
        @Override
        public int hashCode() {
            return 31 * (31 + myName.hashCode()) + myValue.hashCode();
        }
