...
public abstract class JsonValue implements Serializable {
    ...
    /** The logger for the {@code JsonValue} class. */
    private static final Logger LOGGER = LoggerFactory.getLogger(JsonValue.class, MessageCodes.BUNDLE);

    /** The {@code serialVersionUID} for the {@code JsonValue} class. */
    private static final long serialVersionUID = -1934129671227179488L;
    ...
    public JsonArray asArray() {
        throw new UnsupportedOperationException(LOGGER.getMessage(MessageCodes.JSON_043, toString()));
    }
    ...
    public boolean asBoolean() {
        throw new UnsupportedOperationException(LOGGER.getMessage(MessageCodes.JSON_044, toString()));
    }
    ...
    public double asDouble() {
        throw new UnsupportedOperationException(LOGGER.getMessage(MessageCodes.JSON_045, toString()));
    }
    ...
    public JsonObject asObject() {
        throw new UnsupportedOperationException(LOGGER.getMessage(MessageCodes.JSON_046, toString()));
    }
    ...
    public String asString() {
        throw new UnsupportedOperationException(LOGGER.getMessage(MessageCodes.JSON_047, toString()));
    }
    ...
    public boolean equals(final JsonValue aJsonValue, final JsonOptions aConfig) {
        throw new UnsupportedOperationException(LOGGER.getMessage(MessageCodes.JSON_048));
    }
    ...
    @Override
    public int hashCode() {
        throw new UnsupportedOperationException(LOGGER.getMessage(MessageCodes.JSON_049));
    }
    ...
    public String toString() {
        ...
        try {
            ...
            throw new I18nRuntimeException(details); // StringWriter should not throw IOException(s)
        }
    ...
    public void writeTo(final JsonWriter aWriter) throws IOException {
        write(Objects.requireNonNull(aWriter, LOGGER.getMessage(MessageCodes.JSON_009)));
    }
